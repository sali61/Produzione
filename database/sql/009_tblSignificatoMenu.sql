...
(
    ...
    FROM (VALUES
        ...
        (N'Produzione', N'Analisi Risorse', N'Analisi OU', N'Vista OU aggregata per monitorare l andamento economico del perimetro organizzativo con dettaglio coerente alle regole di accesso del profilo.'),
