...
import { useAnalisiRisorsePageState } from './modules/pages/analisiRisorse/useAnalisiRisorsePageState'
...
import { installSortableTables } from './modules/utils/sortableTables'
...
function App() {
  ...
  useEffect(() => installSortableTables(), [])
  const {
    detailCommessa,
    setDetailCommessa,
    detailData,
